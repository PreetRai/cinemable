  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-[#141414] text-white">
      <div className="absolute inset-0">
        <div className="absolute right-0 top-0 h-80 w-80 rounded-full bg-[#e50914]/20 blur-3xl" />
      ...
      <div className="relative mx-auto grid min-h-screen max-w-7xl items-center gap-10 px-4 py-8 md:px-6 lg:grid-cols-[0.95fr_1.05fr] lg:gap-16">
        <div className="mx-auto w-full max-w-md rounded-[2rem] border border-white/5 bg-[#1a1a1a]/95 p-6 shadow-[0_30px_120px_rgba(0,0,0,0.55)] backdrop-blur-xl md:p-8 lg:order-2">
          <div className="mb-8">
            <p className="text-xs uppercase tracking-[0.35em] text-white/45">Get started</p>
            <h2 className="mt-3 text-3xl font-black">Sign Up</h2>
            <p className="mt-2 text-sm text-white/60">
              Create your Cinemable profile and start curating movies.
            </p>
          </div>
          ...
          <div className="relative mb-6">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="rounded-full bg-[#1a1a1a] px-3 text-white/45">Or sign up with email</span>
            </div>
          </div>
          ...
          <div className="mt-5 text-center text-sm text-white/65">
            ...
            <Link to="/login" className="text-[#ffb3b7] transition hover:text-white">
              Login
            </Link>
          </div>
        </div>
        ...
        <div className="hidden lg:block lg:order-1">
          ...
          <h1 className="mt-5 max-w-xl text-5xl font-black leading-tight xl:text-6xl">
            Build a profile that feels like part of the app, not a separate form.
          </h1>
          <p className="mt-6 max-w-lg text-lg leading-relaxed text-white/70">
            Use your account to save movies, join groups, and keep the same cinematic visual language across every screen.
          </p>
